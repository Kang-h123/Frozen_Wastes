...
class Game:
    ...
    def level_2_screen(self):
        ...
        enemy_size_y = 50
        spire_x = 3350
        self.spire_image = pygame.image.load("Imgs/level2_exit.png")
        self.spire_image = pygame.transform.scale(self.spire_image, (250, 600))

        self.all_rect = {"rect1": [300, 700, 200, 50], "rect2": [575, 600, 350, 150], 
                         "rect3": [1050, 600, 600, 150], "rect4": [1700, 500, 600, 150], 
                         "rect5": [2300, 500, 350, 350], "rect6": [2650, 600, 250, 250],
                         "rect7": [3050, 700, 550, 50]}
        self.all_enemy = {
            "enemy1": [1350, 525], "enemy2": [2000, 425], "enemy3": [2340, 325], "enemy4": [2450, 425], "enemy5": [2800, 525], "enemy6": [1650, 425], "enemy7":[2250, 425]
        }
        ...
        while True:
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_e:
                        next_level = self.next_level(char_x, spire_x, 250)
                        if next_level:
                            self.GameWin()
            ...
            self.screen.blit(self.spire_image, (spire_x, 100))
    ...
    def starting_screen(self):
        ...
        self.background_image = pygame.image.load("Imgs/forest.png")
        ...
        self.spire_image = pygame.image.load("Imgs/lonely_spire.png")
        self.spire_image = pygame.transform.scale(self.spire_image, (250, 600))
        self.spire_rect = self.spire_image.get_rect(topleft = (3350, 100))
    ...
    def GameWin(self):
        self.background_image = pygame.image.load("Imgs/win_screen.png")
    ...
    def next_level(self, char_x, towerx, tsizex):
        touched = False
        if towerx < char_x < towerx + tsizex or \
            towerx + tsizex > char_x + 30 > towerx:
            touched = True
        return touched
